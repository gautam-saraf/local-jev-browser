...
def main():
    print()
    print("=" * 60)
    print("GENERATIVE SINGLE-LETTER GOAL-FOCUSED BASELINE")
    print("=" * 60)
    ...
    with sync_playwright() as p:
        ...
        if success:
            print(
                "GENERATIVE_LETTER_GOAL_FOCUSED=PASS"
            )
        else:
            print(
                "GENERATIVE_LETTER_GOAL_FOCUSED=FAIL"
            )
        ...
        output = (
            LOG_DIR
            / (
                "generative_letter_goalfocused_"
